...
setkey(zip.to.county,ZIP)
setcolorder(zip.to.county,
            c("ZIP","ZCTA","STATE","STATEFP","COUNTYNAME","COUNTYFP"))

write.csv(zip.to.county,
          paste0("./zip_to_county_",format(Sys.time(),"%Y%m%d"),".csv"),
          row.names=FALSE)
